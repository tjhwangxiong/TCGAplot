...
#'
#' @description Create a pan-cancer heatmap with symbols indicating statistical significance to reveal the correlation between the expression of a single gene and chemokine.
...
#' @import  ggplot2
#' @export
#' @examples gene_chemokine_heatmap("KLF7")
gene_chemokine_heatmap=function(gene,method = "pearson",lowcol="blue",highcol="red"){
  clist=list()
  plist=list()
