...
#'
#' @description Create a pan-cancer heatmap with symbols indicating statistical significance to reveal the correlation between the expression of a gene set and ICGs (immune checkpoint genes).
...
#' @import  ggplot2
#' @export
#' @examples gs_checkpoint_heatmap("KEGG_APOPTOSIS")
gs_checkpoint_heatmap=function(geneset,method="pearson",lowcol="blue",highcol="red"){
  clist=list()
  plist=list()
