#' tcga_boxplot
#'
#' @description Create a tumor-normal box plot for a single gene with symbols indicating statistical significance in a specific type of cancer.
#'
...
tcga_boxplot=function(cancer,gene,add = "jitter",palette="jco",legend="none"){
