...
#'
#' @description Create a pan-cancer heatmap with symbols indicating statistical significance to reveal the correlation between the expression of a gene set and immune stimulators.
...
#' @import  ggplot2
#' @export
#' @examples gs_immustimulator_heatmap("KEGG_APOPTOSIS")
gs_immustimulator_heatmap=function(geneset,method = "pearson",lowcol="blue",highcol="red"){
  data("tpm")
  clist=list()
  plist=list()
