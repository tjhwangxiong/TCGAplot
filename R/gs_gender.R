#' gene_gender
#'
#' @description Create a box plot for a gene set grouped by gender in a specific type of cancer.
...
#' @import  ggpubr
#' @export
#' @examples gs_gender("COAD","HALLMARK_DNA_REPAIR")
gs_gender=function(cancer,geneset,add = "jitter",palette="jco",legend="none",label="p.signif",method="wilcox.test"){
  ...
  p <- ggpubr::ggboxplot(df, x = "gender", y = geneset,
