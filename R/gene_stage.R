#' gene_stage
#'
#' @description Create a box plot for a single gene grouped by stage in a specific type of cancer.
...
gene_stage=function(cancer,gene,add = "jitter",palette="jco",legend="none",label="p.signif",method="wilcox.test"){
