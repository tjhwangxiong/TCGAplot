#' gene_gender
#'
#' @description Create a box plot for a single gene grouped by gender in a specific type of cancer.
...
gene_gender=function(cancer,gene,add = "jitter",palette="jco",legend="none",label="p.signif",method="wilcox.test"){
