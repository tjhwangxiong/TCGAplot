#' gene_age
#'
#' @description Create a box plot for a single gene grouped by age in a specific type of cancer.
...
gene_age=function(cancer,gene,age=60,add = "jitter",palette="jco",legend="none",label="p.signif",method="wilcox.test"){
